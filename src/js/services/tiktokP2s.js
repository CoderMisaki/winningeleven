...
import { validateTikTokSync as reverseValidate } from './reverseValidation.js';
...
export const TikTokP2sService = {
  // Validasi 100% berbasis reverse Ghidra (FUN_0026c910 / FUN_0028005c / 01323404)
  validate(goals, topGoals, matches, eeMemory = null) {
    return reverseValidate({ goals, topGoals, matches, eeMemory });
  },
  ...
  async createMinimalP2s(goals, topScorerObjs) {
    ...
    // 32MB EE RAM buffer (PCSX2 p2s uncompressed ~35MB, kita buat 32MB + header 0x80)
