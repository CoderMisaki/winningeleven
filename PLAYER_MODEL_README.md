...
2. `generateChances()` — jumlah chance per tim (3–10) dari attack index lawan + dominasi midfield.
...
5. `shotProbability()` — `0.30 + 0.006·(finishing−65) + 0.0035·(positioning−65) + 0.0025·(technique−65) + 0.0015·(power−70) + 0.40·(quality−0.5) − 0.008·(defense_lawan−65) + 0.22·(form−1)`, dikali skala kalibrasi dataset.
